...
- [ ] Define goals and scope: research methodology, dataset source and size, models/baselines, and compute.
- [ ] Describe algorithms, implementation, platform, and language.
- [ ] Specify validation tests and performance metrics.
- [ ] Define minimum, target, and stretch deliverables.
